...
<style>
    ...
    .health-badge.is-healthy { color: var(--green, #16a34a); }
...
<section class="card stocks-table-card">
    <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;justify-content:flex-end;">
            <a href="{{ route('admin.stocks.create') }}" class="btn btn-green">
                        ...
                        <td style="text-align:right;">
                            <div class="actions-dropdown-container">
                                ...
                                <div class="actions-dropdown-menu">
                                    <a class="actions-dropdown-item" href="{{ route('admin.stocks.edit', $stock) }}">
                                    ...
                                    <button
                                        ...
                                        data-adjust-url="{{ route('admin.stocks.adjust', $stock) }}"
