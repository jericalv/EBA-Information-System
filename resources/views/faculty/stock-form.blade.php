...
<style>
    ...
    .size-chip:hover { border-color: var(--success); color: var(--ink); }
    .size-chip.is-on {
        background: var(--success-soft);
        border-color: var(--success);
        color: var(--success-text);
    }
    html[data-theme="dark"] .size-chip.is-on { color: var(--success-text); }
    ...
    /* --success is light mint in dark mode, so text on it must go dark. */
    html[data-theme="dark"] .price-mode-toggle label.is-on { color: #10151B; }
    ...
    html[data-theme="dark"] .sform-field input:focus,
    html[data-theme="dark"] .sform-field select:focus,
    html[data-theme="dark"] .size-row input:focus {
...
@section('content')
<a href="{{ route('staff.stocks.index') }}" class="sform-back">
...
<form
    id="stockForm"
    method="POST"
    action="{{ $isEdit ? route('staff.stocks.update', $stock) : route('staff.stocks.store') }}"
...
>
    ...
    <div class="sform-actions">
        ...
        <div class="sform-actions-buttons">
            <a href="{{ route('staff.stocks.index') }}" class="btn btn-outline btn-sm">Cancel</a>
