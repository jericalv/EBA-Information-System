...
<head>
    ...
    <title>Check Your Email | EBA Information System</title>
        ...
        <div class="auth-form-panel" style="width:50%;display:flex;align-items:center;justify-content:center;padding:48px 40px;background:#fff;">
            <div style="width:100%;max-width:380px;">
                <div class="card-header">
                    ...
                    <p>We sent a confirmation link to your email address. Click the link within 24 hours to complete your registration.</p>
                </div>
                ...
                <p style="font-size:15px;line-height:1.7;color:#4a5568;text-align:center;">
                    We sent a confirmation link to your email address. Click the link within 24 hours to complete your registration.
                </p>

                <div class="card-footer">
                    <a href="{{ route('register') }}">&larr; Back to Register</a>
                </div>
            </div>
        </div>
