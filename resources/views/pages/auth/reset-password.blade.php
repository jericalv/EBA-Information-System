...
<head>
    ...
    <title>Reset Password | EBA Information System</title>
...
<body>
    ...
    <div style="display:flex;min-height:calc(100vh - 72px);">
        ...
        <div class="auth-image-panel" style="width:50%;position:relative;overflow:hidden;">
            <img src="{{ asset('images/vector-1.jpg') }}" alt="" style="width:100%;height:100%;object-fit:cover;display:block;min-height:100vh;">
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <input type="password" id="password" name="password"
                                placeholder="Enter your new password" class="@error('password') is-invalid @enderror"
